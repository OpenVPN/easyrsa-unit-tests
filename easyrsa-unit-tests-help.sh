...
{
	newline 1
	STEP_NAME="help init-pki"
	action

	newline 1
	STEP_NAME="help build-ca"
	action

	newline 1
	STEP_NAME="help build"
	action

	newline 1
	STEP_NAME="help gen-dh"
	action

	newline 1
	STEP_NAME="help gen-req"
	action

	newline 1
	STEP_NAME="help sign-req"
	action

	newline 1
	STEP_NAME="help renew"
	action

	newline 1
	STEP_NAME="help revoke"
	action

	newline 1
	STEP_NAME="help revoke-renewed"
	action
	...
	newline 1
	STEP_NAME="help gen-crl"
	action

	newline 1
	STEP_NAME="help update-db"
	action

	newline 1
	STEP_NAME="help show-req"
	action

	newline 1
	STEP_NAME="help show-cert"
	action

	newline 1
	STEP_NAME="help show-ca"
	action

	newline 1
	STEP_NAME="help show-crl"
	action

	newline 1
	STEP_NAME="help show-expire"
	action

	newline 1
	STEP_NAME="help show-revoke"
	action

	newline 1
	STEP_NAME="help show-renew"
	action

	newline 1
	STEP_NAME="help verify"
	action

	newline 1
	STEP_NAME="help import-req"
	action

	newline 1
	STEP_NAME="help export-p1"
	action

	newline 1
	STEP_NAME="help export-p7"
	action

	newline 1
	STEP_NAME="help export-p8"
	action

	newline 1
	STEP_NAME="help export-p12"
	action

	newline 1
	STEP_NAME="help set-rsa-pass"
	action

	newline 1
	STEP_NAME="help upgrade"
	action
}
